...
<template>
  <svg class="IconCart" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="5.7 0 105.5 126.1"
    ...
    <text x="58.5" y="77" dy=".35em" text-anchor="middle" class="IconCart__text">{{ cart.length }}</text>
  </svg>
</template>
